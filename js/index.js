      ...
      $.ajax({
        url:"https://fcc-weather-api.glitch.me/api/current?lat="+lat+"&lon="+lon , success:function(result){
          ...
          if(result.weather[0].main=="Mist"){
            let img="https://img00.deviantart.net/5da4/i/2012/081/b/d/tree_in_the_fog_by_nigel_kell-d4tjob5.jpg";
          
          }
          if(result.weather[0].main=="Clouds"){
            let img="https://media.self.com/photos/5a625de37b39d91320a3ab0c/4:3/w_728,c_limit/cloudy-pee.jpg";
            
          } 
          if(result.weather[0].main=="Rain"){
            let img="https://images.enca.com/encadrupal/styles/600_383/s3/rainwater.jpg";
          }
          if(result.weather[0].main=="Sunny"){
            let img="https://www.totalguidetobath.com/images/content/GUIDES/Sunny-Days/what-to-do-on-a-sunny-day.jpg";
          }
          if(result.weather[0].main=="Haze"){
            let img="http://footage.framepool.com/shotimg/qf/911258364-mumbai-sunrise-skyline-city-silhouette-haze.jpg";
          }
